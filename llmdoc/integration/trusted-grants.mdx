...
capability scope 或 credential-instance binding。0.17.0 SDK call 已提供网关签发的 caller 与权威期限，
...
- **未实现**：当前代码和上游 `@tool-bridge/sdk/device@0.17.0` 仍没有 credential-instance binding 与
