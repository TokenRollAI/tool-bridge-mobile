...
if (
  androidNotifications?.packageVersion !== '57.0.17'
...
) throw new Error('Android expo-notifications 57.0.17 权限/channel/scheduler 模块未被正确发现')

if (
  iosNotifications?.packageVersion !== '57.0.17'
...
) throw new Error('iOS ExpoNotifications 57.0.17 权限/scheduler 模块未被正确发现')
...
if (
  androidImageManipulator?.packageVersion !== '57.0.16'
...
) throw new Error('Android expo-image-manipulator 57.0.16 未被正确发现')

if (
  iosImageManipulator?.packageVersion !== '57.0.16'
...
) throw new Error('iOS expo-image-manipulator 57.0.16 未被正确发现')
