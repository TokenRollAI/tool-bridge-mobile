...
const required = [
  ...
  'llmdoc/product/requirements-and-roadmap.mdx',
  'llmdoc/capabilities/architecture.mdx',
  'llmdoc/runtime/architecture.mdx',
  'llmdoc/delivery/evidence-language.mdx',
  'llmdoc/delivery/engineering-baseline.mdx',
  'llmdoc/delivery/definition-of-done.mdx',
  'llmdoc/delivery/verification-evidence.mdx',
  'llmdoc/delivery/verification-and-claims.mdx',
  'llmdoc/delivery/github-preview-release.mdx',
