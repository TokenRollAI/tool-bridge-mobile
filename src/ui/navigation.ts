...
export const TAB_OPTIONS = {
  ...
  inbox: { tabBarAccessibilityLabel: '信箱标签页', title: '信箱' },
...
export const TAB_ORDER = ['index', 'inbox', 'capabilities', 'media', 'activity', 'settings'] as const
...
export const TAB_ICONS = {
  ...
  inbox: { active: 'inboxActive', inactive: 'inbox' },
